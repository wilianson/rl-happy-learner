      ...
      sections: [
        {
          ...
          text: "Policy Iteration resuelve un MDP alternando dos pasos: **Evaluación de Política** (calcular V^π) y **Mejora de Política** (construir π' greedy sobre V^π). Se garantiza convergencia a la política óptima π*.",
        },
        {
        ...
        },
        {
          ...
          text: "Si q^π(s, π'(s)) ≥ V^π(s) para todo s, entonces V^{π'} ≥ V^π. El proceso termina cuando π = π' (política estable = política óptima).",
